...
#    Updated: 2023/04/27 12:26:48 by tgomes-l         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = 	main.c	movements.c	parsing.c push_swap.c\
		utils.c two_and_big_sort.c three_five_sort.c
OBJS = $(SRC:.c=.o)
LIB = ./libft/libft.a
HEADERS = Push_swap.h
NAME = push_swap
...
header:	
		...
		@echo "$(VIOLET) $(SPARKS)     ∞∞∞∞ ∞∞∞∞∞∞  ∞∞    ∞∞∞∞   ∞∞∞∞∞∞∞    ∞∞∞∞  ∞∞∞∞∞   $(SPARKS) $(RESET)"
		@echo " $(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)"
		@echo " $(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(SPARKS)$(RESET)$(CYAN)PUSH_SWAP PROJECT!$(RESET)$(CYAN)$(SPARKS)$(SPARKS)$(RESET)"
